...
func TestPreviousNexts(t *testing.T) {
	...
	assert.Equal(t, 14, clean.nextAbsentValue(uint16(12)))
	assert.Equal(t, 14, clean.nextAbsentValue(uint16(13)))
	assert.Equal(t, 14, clean.nextAbsentValue(uint16(14)))
	assert.Equal(t, 60, clean.nextAbsentValue(uint16(60)))
	assert.Equal(t, 101, clean.nextAbsentValue(uint16(100)))
	assert.Equal(t, 101, clean.nextAbsentValue(uint16(101)))
	...
	assert.Equal(t, 12, clean.nextValue(uint16(11)))
	assert.Equal(t, 12, clean.nextValue(uint16(12)))
	assert.Equal(t, 13, clean.nextValue(uint16(13)))
