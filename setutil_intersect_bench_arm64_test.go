...
func benchIntersectPair(shape string, n int, seed int64) (a, b []uint16) {
	...
	switch shape {
	case "dense50":
		return intersectSortedUnique(r, n, 2*n), intersectSortedUnique(r, n, 2*n)
	...
	case "skew8": // one side 8x longer, below the 64:1 galloping cutoff
		...
		return intersectSortedUnique(r, n, 65536), intersectSortedUnique(r, big, 65536)
	case "overlap95": // ~95% shared elements: near-total match density
		a = intersectSortedUnique(r, n, 4*n)
